                ...
                <div class="container container-lg-custom">
                    ...
                    <div class="row py-5 my-4">
                        <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
                            <img alt="Porto" width="237" height="55" src="theme/img/cropped-logo@2x.png"> <br /><br />
                            <h5 class="text-3 mb-3">ABOUT Summit Stocks</h5>
                            <p>Summit Stock news blog and investment strategy guide. All you need to know about blockchain tech, crypto-trading, stock trading and more.</p>
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="media mb-3 pb-1">
                                    <article class="d-flex">
                                        <a href="/why-has-us-stock-market-been-plummeting-for-the-last-three-days">
                                            <img class="mr-3 rounded-circle" src="https://summitstocks.com/wp-content/uploads/2021/03/sigmund-R401qwThw7w-unsplash.jpg" alt="Why has US Stock Market been plummeting for the last three days?" style="max-width: 70px;">
                                        </a>
                                        <div class="media-body">
                                            <a href="#">
                                                <h6 class="text-3 text-color-light opacity-8 ls-0 mb-1">Why has US Stock Market been plummeting for the last three days?</h6>
                                                <p class="text-2 mb-0">Mon, 08 Mar 2021</p>
                                            </a>
                                        </div>
                                    </article>
                                </li>
                                <li class="media">
                                    <article class="d-flex">
                                        <a href="#">
                                            <img class="mr-3 rounded-circle" src="https://summitstocks.com/wp-content/uploads/2021/03/usa-5958092_1920-1024x642.jpg" alt="US Presidency and Stock Market" style="max-width: 70px;">
                                        </a>
                                        <div class="media-body">
                                            <a href="#">
                                                <h6 class="text-3 text-color-light opacity-8 ls-0 mb-1">US Presidency and Stock Market</h6>
                                                <p class="text-2 mb-0">Fri, 05 Mar 2021</p>
                                            </a>
                                        </div>
                                    </article>
                                </li>
